  ...
  presidency: [
    {
      ...
      width: 500, // Optional: specify a width for the image
      height: 300 // Optional: specify a height for the image
    },
    {
                ...
                <AnimatedCard key={index} delay={0.4 + index * 0.2}>
                  ...
                  <CardContent>
                    <Image
                      src={exhibit.image}
                      alt={exhibit.title}
                      width={exhibit.width}  // Use width and height attributes for Next.js Image
